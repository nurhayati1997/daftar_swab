...
<!-- Mirrored from preview.keenthemes.com/metronic/demo2/crud/forms/validation/form-controls.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jan 2022 06:38:04 GMT -->
...
<head>
		...
		<meta charset="utf-8" />
		<title>Pendaftaran SWAB || SYAMRABU</title>
							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<!-- <h2 class="text-white font-weight-bold my-2 mr-5">RSUD SYAMRABU BANGKALAN</h2> -->
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<!--end::Breadcrumb-->
									</div>
    ...
    <script>
        function tambah() {
          ...
          var kab = $("#kab").val()
          var no_hp = $("#no_hp").val()
          var timbul_gejala = $("#timbul_gejala").val()
    ...
    // }
		...
		<script src="assets/js/pages/crud/forms/validation/form-controls5883.js?v=7.2.9"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->

<!-- Mirrored from preview.keenthemes.com/metronic/demo2/crud/forms/validation/form-controls.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jan 2022 06:38:05 GMT -->
</html>